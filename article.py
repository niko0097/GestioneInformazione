class article():
	...
	def put_on_db(self):
		...
		self.query = """INSERT INTO {} VALUES('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}' , '{}', '{}');""".format(self.tipo, self.key, self.mdate, self.autori, self.title, self.pages, self.year, self.volume, self.journal, self.number, self.ees, self.editors, self.url, self.isbn)
		#print(self.query)
		return self.query
