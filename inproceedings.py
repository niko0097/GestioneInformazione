class inproceedings:
	...
	def put_on_db(self):
		...
		self.query = "INSERT INTO {} VALUES('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}');".format(self.tipo , self.key, self.mdate, self.autori , self.editors, self.isbn , self.title, self.pages, self.year, self.booktitle, self.ees, self.crossref, self.url)
		#print(self.query)
		return self.query
